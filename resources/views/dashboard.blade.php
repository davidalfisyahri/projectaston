...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <!-- Low Stock Alert -->
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex items-center gap-4 hover:shadow-md transition">
        <div class="w-14 h-14 rounded-full {{ $lowStockCount > 0 ? 'bg-red-100 text-red-600' : 'bg-green-100 text-green-600' }} flex items-center justify-center shrink-0">
            @if($lowStockCount > 0)
        ...
        <div>
            ...
            <h3 class="text-2xl font-bold {{ $lowStockCount > 0 ? 'text-red-600' : 'text-gray-800' }}">{{ $lowStockCount }} Item(s)</h3>
        </div>
    </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="/customer-request" class="text-sm text-blue-600 hover:underline font-medium">Lihat Semua</a>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="px-4 py-4 text-center text-gray-500">Tidak ada data permintaan terbaru.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="/inventory" class="text-sm text-blue-600 hover:underline font-medium">Gudang</a>
        </div>
        ...
        <div class="overflow-y-auto max-h-[300px] pr-2">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between p-3 bg-red-50 border border-red-100 rounded-xl">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-red-200 text-red-600 flex justify-center items-center font-bold">
                                !
                            </div>
                            <div>
            ...
            @else
                <div class="flex flex-col items-center justify-center h-48 text-gray-400">
                    <svg class="w-12 h-12 mb-2 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
