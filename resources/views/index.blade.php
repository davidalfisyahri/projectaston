...
<body class="font-sans text-gray-800 scroll-smooth">
    ...
    <header class="fixed w-full bg-white/80 backdrop-blur-md shadow-sm z-50">
        <div class="max-w-7xl mx-auto flex items-center px-6 py-4">
            ...
            <div class="flex items-center gap-10">
                ...
                <nav class="hidden md:flex gap-8 text-sm font-medium font-heading">
    ...
    <section id="about" class="py-24 px-6 max-w-6xl mx-auto text-center">
        <h2 class="font-heading text-3xl font-bold mb-6 text-red-800">About Us</h2>
        <p class="text-gray-600 max-w-3xl mx-auto"><span class="text-red-500 font-semibold">
                PT. Istimewa Aston Indonesia
            </span> adalah perusahaan penyedia material
            konstruksi terkemuka yang berdedikasi untuk
            mendukung pembangunan infrastruktur dan properti di seluruh Indonesia. Berbekal pengalaman dan komitmen
            terhadap kualitas, kami hadir sebagai mitra strategis dan solusi satu atap (one-stop solution) untuk
            kebutuhan Beton
    ...
    <!-- <section class="py-24 px-6 bg-red-50">
        <div class="max-w-6xl mx-auto text-center">
            <h2 class="font-heading text-3xl font-bold mb-6 text-red-800">Legalitas</h2>
    ...
    <!-- Motto -->
    <section id="motto" class="py-24 px-6 bg-red-50">
        <div class="max-w-4xl mx-auto text-center">
            <h2 class="font-heading text-3xl font-bold mb-10 text-red-800">Motto</h2>
    ...
    <section class="py-24 px-6">
        <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 text-center">
            ...
            <div class="p-6 rounded-2xl shadow bg-white border-t-4 border-red-700">
                <h3 class="font-heading font-semibold text-lg mb-2 text-red-700">Visi</h3>
            ...
            <div class="p-6 rounded-2xl shadow bg-white border-t-4 border-red-700">
                ...
                <h3 class="font-heading font-semibold text-lg mb-4 text-red-700 text-center">
                    Misi
                </h3>
    ...
    <section id="product" class="py-24 px-6 bg-red-50">
        <h2 class="font-heading text-3xl font-bold mb-16 text-center text-red-800">
            Our Products
        </h2>
        ...
        <div class="max-w-7xl mx-auto mb-20">
            ...
            <!-- Title -->
            <div class="mb-8">
                <h3 class="font-heading text-2xl font-semibold text-red-800">BETON</h3>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <!-- Title -->
            <div class="mb-8">
                <h3 class="font-heading text-2xl font-semibold text-red-800">MATERIAL ALAM</h3>
                <p class="text-gray-500 text-sm">PT ISTIMEWA ASTON INDONESIA
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="group">
                    ...
                    <div class="relative h-[500px] rounded-3xl overflow-hidden shadow-lg">
                        ...
                        <!-- Gambar -->
                        <img src="{{ asset('asset/image/pasir_tayan.jpg') }}" alt="Semen Tiga Roda"
                            class="absolute inset-0 w-full h-full object-cover">
                ...
                <div class="group">
                    ...
                    <div class="relative h-[500px] rounded-3xl overflow-hidden shadow-lg">
                        ...
                        <!-- Gambar -->
                        <img src="{{ asset('asset/image/batu_split.jpg') }}" alt="Semen Tiga Roda"
                            class="absolute inset-0 w-full h-full object-cover">
                    ...
                    <!-- Glass Content -->
                    <div
                        class="-mt-10 backdrop-blur-md bg-white/70 border border-white/40 rounded-2xl p-5 shadow-md mx-3 overflow-x-auto">
    ...
    <!-- Footer -->
    <footer id="contact" class="bg-gradient-to-r from-red-900 via-red-800 to-red-700 text-white pt-16 pb-8 px-6">
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
                <div class="flex items-center gap-3 mb-4">
                    <img src="{{ asset('asset/image/Logo_aston2.png') }}" class="w-16 h-16 object-contain" alt="">
                    <h1 class="font-heading text-lg font-bold leading-tight">
                        PT. Istimewa Aston Indonesia
                    </h1>
                </div>
            ...
            <!-- NAVIGASI -->
            <div>
                <h3 class="font-heading text-lg font-semibold mb-4">Navigasi Cepat</h3>
                <ul class="space-y-2 text-sm text-gray-200">
                    <li><a href="#home" class="hover:text-white">Home</a></li>
                    <li><a href="#about" class="hover:text-white">About</a></li>
                    <li><a href="#product" class="hover:text-white">Product</a></li>
                    <li><a href="#motto" class="hover:text-white">Motto</a></li>
                </ul>
            </div>

            <!-- HUBUNGI -->
            <div>
                <h3 class="font-heading text-lg font-semibold mb-4">Hubungi Kami</h3>
                ...
                <div class="space-y-3 text-sm text-gray-200">
                    ...
                    <div class="flex items-center gap-3">
                        ✉️ <span>istimewabetonindonesiapt@gmail.com</span>
                    </div>
            ...
            <div class="lg:border-l lg:border-white/20 lg:pl-6">
                <h3 class="font-heading text-lg font-semibold mb-4">Legalitas</h3>

                <ul class="space-y-2 text-sm text-gray-200">
                    <li>PT. Istimewa Aston Indonesia</li>
                    <li>Kabupaten Bogor</li>
                    <li class="leading-relaxed">
                        SK Menkumham No. AHU-0008876.AH.01.01.2026
                    </li>
                </ul>
            </div>
        ...
        <div class="border-t border-white/20 mt-12 pt-6 text-center text-sm text-gray-300">
            © {{ date('Y') }} PT. Istimewa Aston Indonesia. All rights reserved.
        </div>
